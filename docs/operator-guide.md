...
1. Define the operator's treatment-facility coverage and crew intake process.
2. Define consent and purpose categories for treater/facility records.
...
- safety-critical escalation path (chemical exposure, ventilation
  failure, equipment condition)
- provenance for all operating records (treater and facility both
  independently registered)
- human review for high-risk cases
- audit export for all gated actions
- a hard, unconditional block on any attempt to route a
  treatment-execution decision, a chemical-safety-clearance decision, or
...
treatment-execution decision, a chemical-safety-clearance decision, or a
